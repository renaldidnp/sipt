        ...
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-md-6 mb-2 mb-md-0">
                    <a href="<?= site_url('jadwal/create') ?>" class="btn btn-primary btn-block">Tambah Jadwal Acara</a>
                </div>
                <div class="col-md-6">
                    <form action="<?= site_url('datakaryawan/search') ?>" method="GET" class="d-flex align-items-center">
                        <input type="text" name="keyword" class="form-control me-2" placeholder="Cari jadwal acara...">
            ...
            <div class="card">
                <h5 class="card-header">Data Jadwal Acara</h5>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            <?php foreach ($jadwal_acara as $k) { ?>
                                <tr>
                                    <td><?= $k['id'] ?></td>
                                    <td><?= $k['nama_acara'] ?></td>
                                    <td><?= $k['lokasi_acara'] ?></td>
                                    <td><?= $k['tanggal_acara'] ?></td>
                                    <td><?= $k['harga_tiket'] ?></td>
                                    <td>
